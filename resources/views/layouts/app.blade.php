...
<head>
    ...
    <!-- SEO Meta -->
    <title>@yield('title', 'BlogHub — Insightful Articles on Tech, Lifestyle & More')</title>
    <meta name="description" content="@yield('meta_description', 'Discover thoughtful articles on technology, lifestyle, travel, food, health, and more. Written for curious minds.')">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="{{ url()->current() }}">

    <!-- Open Graph -->
    <meta property="og:title" content="@yield('og_title', 'BlogHub')">
    <meta property="og:description" content="@yield('meta_description', 'Discover thoughtful articles on technology, lifestyle, travel, food, health, and more.')">
...
<body>
    ...
    <nav class="navbar" id="main-navbar" aria-label="Main navigation">
        <div class="container navbar-inner">
            <a href="{{ route('blogs.index') }}" class="navbar-brand" aria-label="BlogHub Home">
            ...
            <ul class="navbar-menu" id="navbar-menu" role="menubar">
                <li role="none"><a href="{{ route('blogs.index') }}" class="nav-link {{ request()->routeIs('blogs.index') ? 'active' : '' }}" role="menuitem">
                    Blog
                </a></li>
                @auth
                    <li role="none"><a href="{{ route('admin.dashboard') }}" class="nav-link" role="menuitem">
                        Dashboard
                    </a></li>
                    <li role="none">
                ...
                @else
                    <li role="none"><a href="{{ route('login') }}" class="nav-link btn-nav-login" role="menuitem">
                        Admin
                    </a></li>
                @endauth
            </ul>
    ...
    <footer class="footer" role="contentinfo">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} BlogHub. Built with Laravel.</p>
            </div>
        </div>
    </footer>
